...
## Project Structure
    ...
    ├── testapiautoteammem_109416  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_109416`
...
2. Clone this repo and `cd testapiautoteammem_109416`
